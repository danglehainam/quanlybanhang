...
class _Loading implements TransactionsState {
  const _Loading();
...
class _Loaded implements TransactionsState {
  const _Loaded(final  List<TransactionEntity> transactions): _transactions = transactions;
...
/// @nodoc
abstract mixin class _$LoadedCopyWith<$Res> implements $TransactionsStateCopyWith<$Res> {
...
class _Error implements TransactionsState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $TransactionsStateCopyWith<$Res> {
