...
class $$StoresTableTableManager
    extends
        RootTableManager<
          ...
          Store,
          PrefetchHooks Function({bool usersRefs, bool productsRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({usersRefs = false, productsRefs = false}) {
...
class $$ProductsTableTableManager
    extends
        RootTableManager<
          ...
          ProductDriftModel,
          PrefetchHooks Function({bool storeId, bool categoryId})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback: ({storeId = false, categoryId = false}) {
            return PrefetchHooks(
              db: db,
              explicitlyWatchedTables: [],
              addJoins:
